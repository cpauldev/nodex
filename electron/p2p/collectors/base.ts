...
export const BASE_MAINNET_BOOTNODES = [
...
export class BaseNetworkCollector extends DevP2PNetworkCollector {
  readonly networkId = "base" as const;
  readonly networkName = "Base Mainnet";
  protected readonly definition = {
    networkId: this.networkId,
    networkName: this.networkName,
    chainId: 8453,
    bootstrapNodes: BASE_MAINNET_BOOTNODES,
    discoverySource: "Base mainnet bootnode list"
  };
}
